    ...
    stages{
        ...
        stage('Code Analysis'){
            steps{
                ...
                echo "Code analysis completed succesfully"
            }
        }
        ...
        stage('Deploy to Staging'){
            steps{
                ...
                echo "Deplyed to AWS EC2 succesfully"
            }
        }

        stage('Integration Tests on Staging'){
            steps{
                echo "Intergration tests started with Cypress"
        ...
        stage('Deploy to Production'){
            steps{
                ...
                echo "Deplyed to Production succesfully. Server - AWS EC2 instance"
            }
        }
